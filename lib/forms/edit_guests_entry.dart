...
class EditGuestEntry extends StatefulWidget {

  @override
  _EditGuestEntryState createState() => _EditGuestEntryState();
}

class _EditGuestEntryState extends State<EditGuestEntry> {
  int _numberGuests = 0;
        ...
        child: Column(
          ...
          children: [
            ...
            ButtonTheme(
              height: 80,
              child: RaisedButton(
                child: Text('Edit Guest Count', style: TextStyle(
                  fontSize: 34,
                  color: Colors.white,
                )),
                onPressed: _addTable,
