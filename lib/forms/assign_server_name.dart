...
class AssignServerName extends StatefulWidget {

  @override
  _AssignServerNameState createState() => _AssignServerNameState();
}

class _AssignServerNameState extends State<AssignServerName> {
  String _serverName;
        ...
        child: Column(
          ...
          children: [
            ...
            ButtonTheme(
                height: 80,
                child: RaisedButton(
                  child: Text('Assign Server', style: TextStyle(
                    fontSize: 34,
                    color: Colors.white,
                  )),
                  onPressed: _addTable,
